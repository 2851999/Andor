...
public class DeferredScene {
	...
	public DeferredScene() {
		...
		this.screenQuad.renderer.texture = new Image(0, 0);
		this.screenQuad.renderer.texture.pointer = Renderer.geometryBuffer.textures[1];
		...
		if (Settings.Debugging.ShowDeferredRenderingBuffers) {
			...
			this.positionQuad.renderer.texture = new Image(0, 0);
			this.positionQuad.renderer.texture.pointer = Renderer.geometryBuffer.textures[0];
			...
			this.diffuseQuad.renderer.texture = new Image(0, 0);
			this.diffuseQuad.renderer.texture.pointer = Renderer.geometryBuffer.textures[1];
			...
			this.normalQuad.renderer.texture = new Image(0, 0);
			this.normalQuad.renderer.texture.pointer = Renderer.geometryBuffer.textures[2];
			...
			this.depthQuad.renderer.texture = new Image(0, 0);
			this.depthQuad.renderer.texture.pointer = Renderer.geometryBuffer.depthTexture;
