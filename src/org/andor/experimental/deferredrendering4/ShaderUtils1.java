...
public class ShaderUtils1 {
	...
	public static Shader createShader(String path, boolean external) {
		int vertexShader = ShaderUtils1.createShader(path + ".vs", external, Shader.VERTEX_SHADER);
		int fragmentShader = ShaderUtils1.createShader(path + ".fs", external, Shader.FRAGMENT_SHADER);
		//The shader
		Shader shader;
