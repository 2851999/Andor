...
public class DeferredRenderer {
	...
	public void setupBuffers() {
		...
		shader = ShaderUtils.createShader("/resources/andor/experimental3/DefaultPass", false);
		geometryshader = ShaderUtils.createShader("/resources/andor/experimental3/GeometryPass", false);
		gBuffer = new GBuffer();
		if (vertices != null) {
